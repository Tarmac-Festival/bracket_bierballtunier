...
export function registrationDeadlinePassed(tournament: Tournament): boolean {
  return (
...
export function registrationIsOpen(tournament: Tournament): boolean {
  return tournament.registration_enabled && !registrationDeadlinePassed(tournament);
}
