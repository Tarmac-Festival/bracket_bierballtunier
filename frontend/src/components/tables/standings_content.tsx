...
/**
 * One table per stage item, sorted by points. This is the big-screen view: the teams tab
 * itself carries the same standing inside the team cards, where it does not need a table.
 */
